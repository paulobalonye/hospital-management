...
class Document extends CI_Controller {
    ...
    public function form(){  
        ...
        /*----------VALIDATION RULES----------*/
        $this->form_validation->set_rules('doctor_id', display('doctor_name'),'required');
        $this->form_validation->set_rules('description', display('description'),'required|trim|max_length[50]');
