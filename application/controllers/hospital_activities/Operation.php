...
class Operation extends CI_Controller {
    ...
    public function index(){
        $data['module'] = display("hospital_activities");
    ...
    public function form($id = null){ 
        ...
        if (empty($id)) {
            ...
            if ($this->form_validation->run() === true) { 
                ...
                $data['doctor_list'] = $this->doctor_model->doctor_list();
                $data['content'] = $this->load->view('hospital_activities/operation_edit_form',$data,true);
                $this->load->view('layout/main_wrapper',$data);
            } 
        } 
        /*---------------------------------*/
    ...
    public function details($id = null){
        ...
        $data['content'] = $this->load->view('hospital_activities/operation_details', $data, true);
        $this->load->view('layout/main_wrapper',$data);
    } 
