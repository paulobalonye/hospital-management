            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open('medication_visit/visits/create/'.$visit->id,'class="form-inner"') ?>
                            <?php echo form_hidden('id',$visit->id) ?>

                            <div class="form-group row">
                                <label for="patient_id" class="col-xs-3 col-form-label"><?php echo display('patient_id') ?> <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input name="patient_id"  type="text" class="form-control" id="patient_id" placeholder="<?php echo display('patient_id') ?>" value="<?= $visit->patient_id; ?>">
                                    <span></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="visit_date" type="text" class="form-control datepicker" id="visit_date" placeholder="<?php echo display('visit_date') ?>" autocomplete="off" value="<?= $visit->visit_date; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="visit_time" type="text" class="timepicker form-control" id="visit_time" placeholder="<?php echo display('visit_time') ?>" autocomplete="off" value="<?= $visit->visit_time; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                     <textarea name="finding" class="form-control" id="finding"  placeholder="<?php echo display('finding') ?>" rows="3"><?= $visit->finding; ?></textarea>
                                </div>
                            </div>
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                     <textarea name="instructions" class="form-control" id="instructions"  placeholder="<?php echo display('instructions') ?>" rows="3"><?= $visit->instructions; ?></textarea>
                                </div>
                            </div>


                             <div class="form-group row">
                                <label for="fees" class="col-xs-3 col-form-label"><?php echo display('fees') ?> <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input name="fees" type="number" class="form-control" id="fees" placeholder="<?php echo display('fees') ?>" value="<?= $visit->fees; ?>">
                                </div>
                            </div>
