    <div class="row">
        <?php
        if($this->permission->method('sms_template','create')->access()){
        ?>
        <div class="col-md-12 ">
    ...
    <div class="row">
        <?php
        if($this->permission->method('sms_template','create')->access() || $this->permission->method('sms_template','update')->access() || $this->permission->method('sms_template','delete')->access()){
        ?>
        <div class="col-sm-12">
    ...
    <div class="row">
         ...
         <?php
        if($this->permission->method('sms_template','update')->access() || $this->permission->method('sms_template','delete')->access()){
        ?>
        <div class="col-md-12">
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="70">
                                    <?php
                                    if($this->permission->method('sms_template','update')->access()){
                                    ?>
                                    ...
                                    <?php  }?>
                                     ...
                                     <?php
                                    if($this->permission->method('sms_template','delete')->access()){
                                    ?>
