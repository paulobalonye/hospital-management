                    ...
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open_multipart('patient/create','class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="patient_id" type="text" class="form-control" id="patient_id" placeholder="<?php echo display('patient_id') ?>" value="<?php echo $patient->patient_id ?>" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="nss" class="col-xs-3 col-form-label"><?php echo display('number_of_social_security') ?> <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input name="nss" type="text" class="form-control" id="nss" placeholder="<?php echo display('number_of_social_security') ?>" value="<?php echo $patient->nss ?>" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="occupation" type="text" class="form-control" id="occupation" placeholder="<?php echo display('occupation') ?>" value="<?php echo $patient->occupation ?>" autocomplete="off">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-sm-3"><?php echo display('marital_status') ?></label>
                                <div class="col-xs-9">
                                    <?php if(empty($patient->id)){ ?>
                                        <div class="form-check">
                                            <label class="radio-inline">
                                            <input type="radio" name="marital_status" value="Single" <?php echo  set_radio('marital_status', 'Single', TRUE); ?> ><?php echo display('single') ?>
                                            </label>
                                            <label class="radio-inline">
                                            <input type="radio" name="marital_status" value="Married" <?php echo  set_radio('marital_status', 'Married'); ?> ><?php echo display('married') ?>
                                            </label>
                                            <label class="radio-inline">
                                            <input type="radio" name="marital_status" value="Divorce" <?php echo  set_radio('marital_status', 'Divorce'); ?> ><?php echo display('divorce') ?>
                                            </label>
                                        </div>
                                    <?php }else{?>
                                        <div class="form-check">
                                            <label class="radio-inline">
                                            <input type="radio" name="marital_status" value="Single" <?php if($patient->marital_status=='Single'){echo 'checked';}; ?> ><?php echo display('single') ?>
                                            </label>
                                            <label class="radio-inline">
                                            <input type="radio" name="marital_status" value="Married" <?php if($patient->marital_status=='Married'){echo 'checked';}; ?> ><?php echo display('married') ?>
                                            </label>
                                            <label class="radio-inline">
                                            <input type="radio" name="marital_status" value="Divorce" <?php if($patient->marital_status=='Divorce'){echo 'checked';}; ?> ><?php echo display('divorce') ?>
                                            </label>
                                        </div>
                                    <?php }?>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="religion" type="text" class="form-control" id="religion" placeholder="<?php echo display('religion') ?>" value="<?php echo $patient->religion ?>" autocomplete="off">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="donation" class="col-xs-3 col-form-label"><?php echo display('do_you_want_to_be_a_donor') ?> <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input name="donation" type="text" class="form-control" id="donation"  value="<?php echo $patient->donation ?>" autocomplete="off">
                                </div>
                            </div>
