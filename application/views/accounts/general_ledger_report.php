...
<div id="printArea">
            <table width="99%" align="center" style="margin:5px 5px;" cellpadding="5" cellspacing="5" border="2"> 
                ...
                <tr align="center">
                    ...
                    <td colspan="7"><font size="+1" style="font-family:'Arial'"> <strong><?php echo display('general_ledger_of').' '.$ledger->HeadName. display('on') .$dtpFromDate. display('to')  .$dtpToDate;?></strong></font><strong></th></strong>
                </tr>

                <tr>
                    <td height="25"><strong><?php echo display('serial');?></strong></td>
                    <td><strong><?php echo $chkIsTransction?"Transaction Date":"Head Code";?></strong></td>
                    <td><strong><?php echo $chkIsTransction?"Voucher No":"Head Name";?></strong></td>
                    <?php
                    if($chkIsTransction){
                        ?>
                ...
                <h4>
                    ...
                    <br /> <?php echo display('current_balance')?> : <?php echo number_format((!empty($CurBalance)?$CurBalance:0),2,'.',','); ?>
                </h4>
            </table>
        </div>
