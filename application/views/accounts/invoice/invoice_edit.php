    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary" href="<?php echo base_url("accounts/invoice") ?>"> <i class="fa fa-list"></i>  <?php echo display('invoice_list') ?> </a>  
                </div>
            </div> 
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 table-responsive">
                        <?php echo form_open('accounts/invoice/edit/'.$invoice->id) ?> 
...
$(document).ready(function() {   
    ...
    $('body').on('keyup change', '#patient_id', function() {
        ...
        $.ajax({
            url     : '<?php echo base_url('accounts/invoice/patient') ?>',
            method  : 'post',
            dataType: 'json', 
            data    : {
