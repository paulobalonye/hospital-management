                        ...
                        <table class="table">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <input type="text" name="policy_no" class="invoice-input form-control " placeholder="<?php echo display('policy_no') ?>" value="<?php echo $prescription->policy_no ?>">
                                    </th>
                                </tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="<?php echo base_url("prescription/case_study/create") ?>" class="btn btn-primary"><?php echo display('add_patient_case_study') ?></a>
      </div>
    </div>
  </div>
</div>
