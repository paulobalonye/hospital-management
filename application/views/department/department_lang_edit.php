            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open_multipart('department/create_language','class="form-inner"') ?> 

                            <?php echo form_hidden('department_id',$deptLang->department_id) ?>
                            <input type="hidden" name="id" value="<?= $deptLang->id?>">
                                ...
                                <div class="col-xs-9">
                                    <div class="form-check">
                                        ...
                                        <label class="radio-inline">
                                            <?php echo form_radio('language', lcfirst($value), (lcfirst($value)==$deptLang->language)).' ' .$value;?>
                                        </label>
                                        <?php }?>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="name"  type="text" class="form-control" id="name" placeholder="<?php echo display('department_name') ?>" value="<?php echo $deptLang->name ?>">
                                </div>
                            </div>
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <textarea name="description" class="form-control"  placeholder="<?php echo display('description') ?>" rows="7"><?php echo $deptLang->description ?></textarea>
                                </div>
                            </div>
