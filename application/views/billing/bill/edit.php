                    ...
                    <table id="fixTable" class="table table-bordered table-striped">
                        ...
                        <tbody id="services">
                           <?php 
                            ...
                            <tr>
                                <td>
                                    <input name="service_name[]" class="form-control service_name service_data" type="text" placeholder="<?php echo display('service_name') ?>" value="<?php echo $service->name; ?>" readonly><input name="service_id[]" type="hidden" class="service_id" value="<?php echo $service->id; ?>" required>
                                </td>
                                <td>
