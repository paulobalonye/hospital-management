    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary" href="<?php echo base_url("insurance/insurance") ?>"> <i class="fa fa-list"></i>  <?php echo display('insurance_list') ?> </a>  
                </div>
            </div> 
            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        <?php echo form_open_multipart('insurance/insurance/update/'.$insurance->id) ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <textarea maxlength="1024" name="remark" class="form-control"  placeholder="<?php echo display('remark') ?>"  rows="7"><?php echo $insurance->remark ?></textarea>
                                </div>
                            </div> 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="row" style="margin-bottom:10px">
                                    ...
                                    <div class="col-xs-4">
                                        <input name="disease_charge[]" type="text" class="form-control"  placeholder="<?php echo display('disease_charge') ?>" value="<?php echo $value; ?>">
                                    </div>
                                    <div class="col-xs-4">
                                        <div class="btn-group">
...
$(document).ready(function() {
    var html = "<div class=\"row\" style=\"margin-bottom:10px\">"+
            "<div class=\"col-xs-4\">"+
                "<input name=\"disease_name[]\" type=\"text\" class=\"form-control\"  placeholder=\"<?php echo display('disease_name') ?>\">"+
            "</div>"+
            "<div class=\"col-xs-4\">"+
                "<input name=\"disease_charge[]\" type=\"text\" class=\"form-control\"  placeholder=\"<?php echo display('disease_charge') ?>\">"+
            "</div>"+
            "<div class=\"col-xs-4\">"+
                "<div class=\"btn-group\">"+
                    "<button type=\"button\" class=\"btn btn-info add-disease\">+</button>"+
