       ...
       <?php
        ...
        ?>
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary" href="<?php echo base_url("website/banner_sliders/") ?>"> <i class="fa fa-list"></i>  <?php echo display('banner_list') ?> </a>  
                </div>
            </div> 
        <?php } ?>
            ...
            <div class="panel-body  panel-form"> 
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?= form_open_multipart('website/banner_sliders/create','class="form-inner"') ?>
