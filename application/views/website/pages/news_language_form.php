            ...
            <div class="panel-body  panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?= form_open_multipart('website/news/add_lang/'.$news->id,'class="form-inner"') ?>
                           <?= form_hidden('news_id', $news->id)?>

                           <div class="form-group row">
                                <label for="title" class="col-xs-3 col-form-label"><?php echo display('title') ?></label>
                                <div class="col-xs-9">
                                    <input type="text" class="form-control" id="title" placeholder="<?php echo display('title') ?>" value="<?= $news->title?>" readonly>
                                </div>
                            </div>
                           ...
                           <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <img src="<?= base_url($news->featured_image) ?>" alt="Logo" class="img-thumbnail" />
                                </div>
                            </div>
                            <?php } ?>
