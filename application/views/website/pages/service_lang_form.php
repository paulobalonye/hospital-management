                ...
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?= form_open_multipart('website/services/create_language/'.$service->id,'class="form-inner"') ?>
                            ...
                            <?= form_hidden('service_id', $service->id)?>
                             <?= form_hidden('parent', $service->is_parent)?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="name"  type="text" class="form-control" id="name" placeholder="<?php echo display('name') ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <textarea name="description" id="description" class="form-control tinymce"  placeholder="<?php echo display('description') ?>" maxlength="140" rows="7"></textarea>
                                </div>
                            </div>
