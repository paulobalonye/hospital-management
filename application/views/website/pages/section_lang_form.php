                ...
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?= form_open_multipart('website/section/create_language/'.$section->id,'class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                <label for="name" class="col-xs-3 col-form-label"><?php echo display('section_name') ?> </label>
                                <div class="col-xs-9">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <textarea name="description" class="form-control"  placeholder="<?php echo display('subtitle_description') ?>" rows="7"></textarea>
                                </div>
                            </div>
