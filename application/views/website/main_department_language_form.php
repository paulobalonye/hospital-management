            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open_multipart('main_department/add_lang','class="form-inner"') ?> 
                            <?php echo form_hidden('main_id',$department->id) ?>

                            <div class="form-group row">
                                <label for="language" class="col-xs-3 col-form-label"><?php echo display('language') ?> <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                     <?= form_dropdown('language',$languageList, $department->language,'class="form-control" id="language" ') ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="name"  type="text" class="form-control" id="name" placeholder="<?php echo display('department_name') ?>" value="<?= $department->name?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <textarea name="description" class="form-control"  placeholder="<?php echo display('description') ?>" rows="7"><?= $department->description;?></textarea>
                                </div>
                            </div>
