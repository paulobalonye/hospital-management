                ...
                <table width="100%" class="datatable table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo display('prescription') ?></th>
                        ...
                        <?php if (!empty($appointments)) { ?>
                            ...
                            <?php foreach ($appointments as $appointment) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td><center><?php echo (($appointment->status == 1) ? "<i class='label label-warning'>not seen</label>" : "<i class='label label-success'>".display('yes')."</label>"); ?></center></td>
                                    <td class="center">
