        ...
        <div class="panel panel-default thumbnail">
            <div class="panel-heading">
                <div class="btn-group">
                    ...
                    <a class="btn btn-primary" href="<?php echo base_url("dashboard_patient/message/sent") ?>"> <i class="fa fa-share"></i>  <?php echo display('sent') ?> </a>
                            ...
                            <?php foreach ($messages as $message) { ?>
                                <tr>
                                    ...
                                    <td class="center" width="80">
                                        <a href="<?php echo base_url("dashboard_patient/message/inbox_information/$message->id") ?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a> 
                                        <a href="<?php echo base_url("dashboard_patient/message/delete/$message->id/$message->sender_id/$message->receiver_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-trash"></i></a> 
