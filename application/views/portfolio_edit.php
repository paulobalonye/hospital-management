            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open('portfolio/create/'.$portfolio->id,'class="form-inner"') ?>
                        <?php echo form_hidden('id',$portfolio->id) ?>
                                ...
                                <div class="col-xs-9">
                                    <div class="form-check">
                                        ...
                                        <label class="radio-inline">
                                            <?php echo form_radio('language', lcfirst($value),  (lcfirst($value)==$portfolio->language)).' ' .$value;?>
                                        </label>
                                        <?php }?>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="title" type="text" class="form-control" id="title" value="<?= $portfolio->title;?>" placeholder="<?php echo display('designation') ?>">
                                </div>
                            </div>
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="institute" type="text" class="form-control" id="institute" value="<?= $portfolio->institute;?>" placeholder="<?php echo display('institute_name') ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="from_date" type="text" class="form-control datepicker" id="from_date" value="<?= $portfolio->from_date;?>" placeholder="<?php echo display('from_date') ?>" autocomplete="off">
                                </div>
                            </div>
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="to_date" type="text" class="form-control datepicker" id="to_date" value="<?= $portfolio->to_date;?>" placeholder="<?php echo display('to_date') ?>" autocomplete="off">
                                </div>
                            </div>
