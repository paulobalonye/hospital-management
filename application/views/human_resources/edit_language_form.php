            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        <?php echo form_open_multipart('human_resources/employee/add_language/'.$employee->id,'class="form-inner"') ?> 
                                ...
                                <div class="col-xs-9">
                                    <div class="form-check">
                                        ...
                                        <label class="radio-inline">
                                            <?php echo form_radio('language', lcfirst($value),  (lcfirst($value)==$employee->language)).' ' .$value;?>
                                        </label>
                                        <?php }?>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="phone" class="form-control" type="text" placeholder="<?php echo display('phone') ?>" id="phone" value="<?php echo $employee->phone ?>" >
                                </div>
                            </div>
